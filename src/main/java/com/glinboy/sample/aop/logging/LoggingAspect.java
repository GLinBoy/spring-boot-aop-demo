package com.glinboy.sample.aop.logging;
...
public class LoggingAspect {
	 ...
	 */
	@Pointcut("within(com.glinboy.sample.repository..*)" + " || within(com.glinboy.sample.service..*)"
			+ " || within(com.glinboy.sample.web.rest..*)")
